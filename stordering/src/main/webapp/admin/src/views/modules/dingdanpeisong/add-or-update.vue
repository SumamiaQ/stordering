  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fahuoshijian" label="发货时间" prop="fahuoshijian">
              <el-input v-model="ruleForm.fahuoshijian" 
                placeholder="发货时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
