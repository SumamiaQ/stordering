<template>
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(102, 205, 170, 0.7);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">食堂订餐小程序注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210228/3bca3bf727af4c4eb8e8f6fd76bfd996.jpg");
		height: 100vh;
