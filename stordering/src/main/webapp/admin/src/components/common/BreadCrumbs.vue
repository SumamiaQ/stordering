<template>
  <el-breadcrumb class="app-breadcrumb" separator="⭐⭐" style="height:50px;backgroundColor:rgba(102, 205, 170, 0.97);borderRadius:16px;padding:0px 20px 0px 20px;boxShadow:;borderWidth:2px;borderStyle:dotted solid double dashed;borderColor:rgba(237, 214, 84, 0.03);">
