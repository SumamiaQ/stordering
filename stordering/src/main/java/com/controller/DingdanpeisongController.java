...
public class DingdanpeisongController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DingdanpeisongEntity dingdanpeisong, HttpServletRequest request){
		...
		if(tableName.equals("shangjia")) {
			dingdanpeisong.setShangjiahao((String)request.getSession().getAttribute("username"));
		}
