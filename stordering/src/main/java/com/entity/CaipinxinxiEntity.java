...
public class CaipinxinxiEntity<T> implements Serializable {
	...
	public CaipinxinxiEntity(T t) {
		try {   
			BeanUtils.copyProperties(this, t);   // 可能出现异常的代码
		} catch (IllegalAccessException | InvocationTargetException e) {      //异常类名A（IllegalAccessException | InvocationTargetException） e
	...
	@JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")  //@Jsonformat默认是标准时区的时间，多出现少8个时区的情况。使用时，加时区 中华，东八区
